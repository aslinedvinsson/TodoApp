...
The application offers an interactive user interface through a console, enabling users to navigate various options seamlessly.
...
## Program goal
The goal of the program is to provide the user a tool to create todo-lists and manage the tasks in every todolist

The program aims to provide users with a tool for creating and managing todo-lists, enabling effective task management within each list.
