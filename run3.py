...
class TaskHandler:
    ...
    def add_task(self, task_data, worksheet_name = None, worksheet = None):
        ...
        """
        try:
            if worksheet_name is not None and worksheet is not None and self.worksheet:
                #if self.worksheet:
                row_data = [worksheet_name] + task_data if worksheet_name \
                is not None else task_data
